    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Listado simplificado de expedientes activos e históricos.</p>
        </div>
        ...
        <CardContent className="p-0">
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/50">
                <TableHead className="font-bold">Expediente</TableHead>
                <TableHead className="font-bold">Asistencia</TableHead>
          ...
          {filteredRequests.length === 0 && (
            <div className="py-20 text-center">
              ...
              <p className="text-lg font-medium text-muted-foreground">No se encontraron servicios</p>
            </div>
          )}
        </CardContent>
      </Card>
